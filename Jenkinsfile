    ...
    stages {    
        stage('Build') {
		 ...
		 echo "building the app"
               ...
               bat 'dotnet restore C:/Users/supritha.a.suresh/Documents/demo/pipeline-jenkins-dotnetcore/TDD/TDD.sln'
               bat 'dotnet build "C:/Users/supritha.a.suresh/Documents/demo/pipeline-jenkins-dotnetcore/TDD/TDD.sln'                     
            }
        } 
